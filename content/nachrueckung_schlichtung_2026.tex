...
%\begin{center}
%	{\Huge \headingfont\bfseries Nachbesetzung der zum 01.01.2026 vakant gewordenen Stelle in der Schlichtung}\\[0.5em]
...
\begin{itemize}
	\item Milena Robbers wurde bei der ordentlichen Wahl 2024 gewählt, ihr Ausscheiden vor 2027 ist somit vorzeitig.
	...
	\item Eine Nachwahl gem. § 4 Abs. Satz 2 i.V.m. Abs. 3 der Wahlordnung findet somit nicht statt.
\end{itemize}

\begin{tenor}{Feststellung des Wahlausschusses}
	Ole Oldenburg (M17074) tritt gem. § 3 Abs. 4 Satz 1 der Wahlordnung Nachfolge von Milena Robbers (M8850) an. Die Amtszeit läuft bis zur ordentlichen Wahl 2027.
	
	\vspace{0.5\baselineskip}
	\raggedleft\textbf{Feststellung: einstimmig}
\end{tenor}
